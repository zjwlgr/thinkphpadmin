...
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'conf.inc.php';
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.'requestcore'.DIRECTORY_SEPARATOR.'requestcore.class.php';
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'util'.DIRECTORY_SEPARATOR.'mimetypes.class.php';
require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'util'.DIRECTORY_SEPARATOR.'oss_util.class.php';
//检测语言包
if(file_exists(OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'lang'.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php')){
    require_once OSS_API_PATH.DIRECTORY_SEPARATOR.'oss'.DIRECTORY_SEPARATOR.'lang'.DIRECTORY_SEPARATOR.ALI_LANG.'.inc.php';
}else{
